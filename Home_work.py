...
# first_el = int(input('enter first element:   '))
# step = int(input('enter step:   '))
# count_el = int(input('enter count elements:   '))
# res_arr = [first_el + (i - 1) * step for i in range(1, count_el + 1)]
# print(*res_arr)

# Задача 32: Определить индексы элементов массива (списка), значения которых принадлежат заданному диапазону
# (т.е. не меньше заданного минимума и не больше заданного максимума)

# user_arr = [-5, 9, 0, 3, -1, -2, 1, 4, -2, 10, 2, 0, -9, 8, 10, -9, 0, -5, -5, 7]
# range_filter = [1, 19]
